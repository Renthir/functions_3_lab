...
// CODE HERE
const totalPopulation = populations.reduce((arr, cur) => arr + cur)
...
// CODE HERE
let pricesAfterTax = orders.map((e, i) => e.price * (1 + e.tax))
...
// CODE HERE
let bobsTotal = purchases.filter((e) => e.owner ==='Bob').reduce((acc, cur) => {return acc + cur.price}, 0)
